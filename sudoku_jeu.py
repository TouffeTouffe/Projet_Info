...
class Ui_Play(object):
    def setupUi(self, Jeu, x, y):
        ...
        for i in range(x * y):
            self.bloc = QtWidgets.QTableWidget(Jeu)

            self.topmiddle.setRowCount(y)
            self.topmiddle.setColumnCount(x)
            self.topmiddle.setObjectName("bloc" + "i")
            ...
            self.gridLayout_2.addWidget(self.topmiddle, i // x, i % y, 1, 1)

        self.topright = QtWidgets.QTableWidget(Jeu)
        ...
        self.middleleft = QtWidgets.QTableWidget(Jeu)
        ...
        self.middlemiddle = QtWidgets.QTableWidget(Jeu)
        ...
        self.middleright = QtWidgets.QTableWidget(Jeu)
        ...
        self.topleft = QtWidgets.QTableWidget(Jeu)
        ...
        self.bottomleft = QtWidgets.QTableWidget(Jeu)
        ...
        self.bottommiddle = QtWidgets.QTableWidget(Jeu)
        ...
        self.bottomright = QtWidgets.QTableWidget(Jeu)
